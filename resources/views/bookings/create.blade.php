    ...
    <div class="p-6">
        ...
        <form action="{{ route('booking.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="full_name" id="full_name" value="{{ old('full_name') }}" required
                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#196890] focus:border-[#196890]">
                </div>
            ...
            <div class="flex justify-end">
                <a href="{{ route('rooms.show', $room->id) }}" class="mr-4 inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#196890]">
                    Cancel
                </a>
                <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#196890] hover:bg-[#145570] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#196890]">
                    Complete Booking
                </button>
            </div>
        </form>
